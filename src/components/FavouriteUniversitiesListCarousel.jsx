...
const UniversityCarousel = () => {
  ...
  if (error) return <p>Add universities to favorites</p>;
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        {favourites.map((fav) => {
          const isFavorite = true; // All are favorites in this context
          return (
            <Link
              key={fav.universityId}
              to={`/view-university/${fav.universityId}`}
              ...
              >
                ...
                {isAuthenticated && (
                  <img
                    ...
                    onClick={(e) => handleFavClick(e, fav.universityId, isFavorite)}
                    style={{
                      position: "absolute",
                      right: "12px",
                      top: "20px",
                    ...
                    tabIndex={0}
                    onKeyDown={(e) =>
                      e.key === "Enter" && handleFavClick(e, fav.universityId, isFavorite)
                    }
                  />
                )}
